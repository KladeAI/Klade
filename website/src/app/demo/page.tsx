        ...
        <FadeIn>
          <div className="mx-auto max-w-4xl text-center">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-3">
              <Button href="https://calendly.com/adam-kladeai/new-meeting" eventName="demo_cta_click" eventPayload={{ placement: "demo_hero", cta: "book_demo" }}>
                Book a Live Demo
              </Button>
      ...
      <Section className="py-10 md:py-14">
        <FadeIn>
          <div className="rounded-3xl border border-[#4fd1ff]/15 bg-gradient-to-r from-[#0a0f2c] via-[#10162f] to-[#0a0f2c] p-8 md:p-12 text-center">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-3">
              <Button href="https://calendly.com/adam-kladeai/new-meeting" eventName="demo_cta_click" eventPayload={{ placement: "demo_footer", cta: "book_demo" }}>
                Book a Live Demo
              </Button>
